<div class="scene i:scene tests">
	...
	<div class="tests">
		...
		<? function addMembership_withSubscriptionNoPrice_returnMembershipWithSubscriptionId() {
			...
			$subscription = $SubscriptionClass->addSubscription($membership_item_id);
	...
	<div class="tests">
		...
		function updateMembership_addSubscriptionId_returnUpdatedMembership() {
			...
			$subscription_2 = $SubscriptionClass->addSubscription($membership_item_2_id, ["order_id" => $order_2_id]);
