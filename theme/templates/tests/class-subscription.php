...
<div class="scene i:scene tests">
	...
	<div class="tests">
		...
		$subscription = $SubscriptionClass->addSubscription($item["item_id"]);
		...
		$subscription_duplet = $SubscriptionClass->addSubscription($item["item_id"]);
		...
		$subscription = $SubscriptionClass->getSubscriptions(array("item_id" => $item["item_id"]));
		if(
			$subscription &&
			$subscription["item_id"] == $item["item_id"] &&
			!$subscription["expires_at"] &&
		...
		if(
			...
			!$SubscriptionClass->getSubscriptions(array("item_id" => $item["item_id"]))
		): ?>
