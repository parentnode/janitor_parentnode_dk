...
<? endif; ?>
	...
	<div class="tests mov">
		...
		<? if(autoconvertVideo("mov/256x144.mov", array(220000, 240000), 256, 144, "m2v1")): ?>
			<div class="testpassed">webm -> mov (same proportion) - correct (<?= $fs->filesize(PUBLIC_FILE_PATH."/autoconversion-test/mov/256x144.mov") ?>)</div>
		<? else: ?>
		...
		<? if(autoconvertVideo("mov/300x300.mov", array(405000, 425000), 300, 300, "m2v1")): ?>
			<div class="testpassed">webm -> mov (different proportion) - correct (<?= $fs->filesize(PUBLIC_FILE_PATH."/autoconversion-test/mov/300x300.mov") ?>)</div>
		<? else: ?>
			<div class="testfailed">webm -> mov (different proportion) - API error</div>
		<? endif; ?>

		<? if(autoconvertVideo("mov/256x144.ogv", array(135000, 155000), 256, 144, "theora")): ?>
			<div class="testpassed">webm -> ogv (same proportion) - correct (<?= $fs->filesize(PUBLIC_FILE_PATH."/autoconversion-test/mov/256x144.ogv") ?>)</div>
		<? else: ?>
		...
		<? if(autoconvertVideo("mov/256x144.webm", array(160000, 180000), 256, 144, "vp8")): ?>
			<div class="testpassed">webm -> webm (same proportion) - correct (<?= $fs->filesize(PUBLIC_FILE_PATH."/autoconversion-test/mov/256x144.webm") ?>)</div>
		<? else: ?>
		...
		<? if(autoconvertVideo("mov/256x144.mp4", array(110000, 130000), 256, 144, "h264")): ?>
			<div class="testpassed">webm -> mp4 (same proportion) - correct (<?= $fs->filesize(PUBLIC_FILE_PATH."/autoconversion-test/mov/256x144.mp4") ?>)</div>
		<? else: ?>
		...
		<? if(autoconvertVideo("mov/256x144.3gp", array(345000, 365000), 352, 288, "s263")): ?>
			<div class="testpassed">webm -> 3gp (same proportion) - correct (<?= $fs->filesize(PUBLIC_FILE_PATH."/autoconversion-test/mov/256x144.3gp") ?>)</div>
		<? else: ?>
